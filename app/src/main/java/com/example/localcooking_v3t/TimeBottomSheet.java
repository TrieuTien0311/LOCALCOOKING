...
public class TimeBottomSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        radioGroup.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId == R.id.radioMacDinh) currentSort = 0;
            else if (checkedId == R.id.radioGiaBatDauSomNhat) currentSort = 1;
            else if (checkedId == R.id.radioGiaBatDauMuonNhat) currentSort = 2;
        });
        ...
        btnXoaLoc.setOnClickListener(v -> {
            ...
            radioGroup.check(R.id.radioMacDinh);
